...
extension Identity {
   /**
    * Stores a random UUID that uniquely identifies the user/install using the native UserDefaults . standard. The user identifier may be lost if the UserDefaults are cleared or altered in any other way, a new  unique identifier will be created in it's place
...
extension Identity {
    ...
    * - Remark: keychain doesn't work with unit tests very well so userdefault is fine for now etc
    */
